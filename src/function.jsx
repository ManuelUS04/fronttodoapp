...
export const sendRequest = async(method, params, url, redir='', token=true) => {
    ...
    .then((response) => {
        ...
        if(res.status == 500) show_alert(res.message, 'error')
        else {
...
export const confirmation = async(name, url, redir) => {
    ...
    alert.fire({
        ...
        confirmButtonText:'<i class="fa-solid fas-check"></i> Si, Eliminar',
        cancelButtonText:'<i class="fa-solid fas-ban"></i> Cancelar'
    }).then((result)=>{
